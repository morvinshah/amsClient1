...
<center>
<b>Select the Flight to Update</b>
<br>
<form name="delMovies" id="delMovies" onsubmit="return validateRadio1()" method="post" action="UpdateFlightInfo">
...
<br>
<input class="btn btn-large btn-primary" type="submit" value="Update Selected" >
</form>
</center>
</body>
